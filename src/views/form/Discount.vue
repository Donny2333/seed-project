<template>
  <div>
    ...
    <mt-field name="discount" v-validate="'required'" label="优惠券额度" placeholder="请填写优惠券额度" type="tel" v-model="discount">
      <span class="validate" v-show="errors.has('discount')">{{ errors.first('discount') }}</span>
    </mt-field>
